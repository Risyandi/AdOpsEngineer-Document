 ...
 */
/**
 * append a element on middle
 */
var numMiddle = Math.ceil($(".setpage p").length / 2);
var numLength = Math.ceil($(".setpage p").length);
console.log(numMiddle, ":value middle");
console.log(numLength, ":value length");
$(".setpage p:nth-child(" + numMiddle + ")").append("<h1>hallo ini iklan</h1>");
