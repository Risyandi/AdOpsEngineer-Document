/**
 * -------------------------------------------------------------------------------------
 * this script not working on mobile, but on desktop this effect parallax well working.
 * -------------------------------------------------------------------------------------
 */
// var parallaxStyle = "\
// .item-parallaxAds{\
...
// parent.document.querySelector('div.parallax-mobile')
//.parentNode.insertBefore(parallaxElementTemplate, parent.document.querySelector('div.parallax-mobile'));
...
/**
 * -------------------------------------------------------------------
 * new script for parallax working both device mobile and desktop
 *  ------------------------------------------------------------------
 */ 
var parallaxStyle = "\
.title-ads{\
